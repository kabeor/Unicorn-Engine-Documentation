...
![image.png](https://i.loli.net/2020/01/17/iyodlNFY7hHEOgS.png)

VS打开unicorn.sln项目文件，解决方案自动载入这些

![image.png](https://i.loli.net/2020/01/17/fOnNpSKvjYyc7QB.png)

如果都需要的话，直接编译就好了，只需要其中几种，则右键解决方案->属性->配置属性 如下

![image.png](https://i.loli.net/2020/01/17/F3rSByYuNTGDtC1.png)
...
![image.png](https://i.loli.net/2020/01/17/YCMNcEVyX8GHoPb.png)
...
![image.png](https://i.loli.net/2020/01/17/I25E9sWcJpGyax7.png)

在VS解决方案中，头文件添加现有项unicorn.h，资源文件中添加unicorn.lib，重新生成解决方案

![image.png](https://i.loli.net/2020/01/17/OVaHwelNQ4tcLmo.png)
...
![image.png](https://i.loli.net/2020/01/17/bpu4r8hgzUvO7Pm.png)
...
![image.png](https://i.loli.net/2020/01/18/q3JtOQRPl5xTFKp.png)
...
![image.png](https://i.loli.net/2020/01/18/NExsavSgu4yMbBQ.png)
...
![image.png](https://i.loli.net/2020/01/18/dqKBwAWUL7XvypE.png)
...
![image.png](https://i.loli.net/2020/01/18/ZtRKvUoaPTlshJ4.png)
...
![image.png](https://i.loli.net/2020/01/18/IZhyWrGebA5tT4i.png)
...
![image.png](https://i.loli.net/2020/01/18/MbZk8KjQFqJOxmd.png)
...
![image.png](https://i.loli.net/2020/01/19/DkztJcigHCdmnRp.png)
...
![image.png](https://i.loli.net/2020/01/19/ABkexFCfphu3zIg.png)
...
![image.png](https://i.loli.net/2020/01/19/l1AhdxgKE2U3tZB.png)
...
![image.png](https://i.loli.net/2020/01/19/l4HhgDzcJIVvFNU.png)
...
![image.png](https://i.loli.net/2020/01/19/K4HMijIVt6lofvT.png)
...
![image.png](https://i.loli.net/2020/01/20/aU1lbmxMjXA5g3K.png)
...
![image.png](https://i.loli.net/2020/01/20/kbrF7NdV6LDxnYI.png)
...
![image.png](https://i.loli.net/2020/01/20/juNPWvwGUlraKRh.png)
